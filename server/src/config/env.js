...
module.exports = {
    ...
    DB_NAME: process.env.DB_NAME || 'medicore_db',
    DB_USER: process.env.DB_USER || 'medicore_app',
    DB_PASSWORD: process.env.DB_PASSWORD || 'MediCore@2026',
    ...
    // Notifications
    MEDICATION_REMINDER_MINUTES: parseInt(process.env.MEDICATION_REMINDER_MINUTES) || 15,
    APPOINTMENT_REMINDER_HOURS: parseInt(process.env.APPOINTMENT_REMINDER_HOURS) || 10,
